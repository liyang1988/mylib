 ...
 *
 * `UIOneFingerZoomGestureRecognizer` is a concrete subclass of `UIGestureRecognizer` that looks for long-press gestures
 ...
 */
@interface UIOneFingerZoomGestureRecognizer : UIGestureRecognizer
