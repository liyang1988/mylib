...
- (NSDate *) dateByAddingMonthes: (NSUInteger) dMonthes;
...
//从今天向后加dMonthes个月，计算总天数
//注意：如果今天在本月的日期超了dMonthes月后的月份内天数，按最后
//     一月的最后日期为准。
- (NSInteger) daysByAddingMonthes: (NSInteger)dMonthes;
