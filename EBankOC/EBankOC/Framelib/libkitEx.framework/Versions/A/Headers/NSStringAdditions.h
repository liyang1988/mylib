 ...
 */
- (NSDictionary*)queryDictionary:(NSString*)string urlHeader:(NSString**)header;
...
- (UIImage*)QRImage:(UIImage*)centerIcon radius:(CGFloat)radius;
- (UIImage*)QRImage:(UIColor*)color centerIcon:(UIImage*)icon radius:(CGFloat)radius;
@end
